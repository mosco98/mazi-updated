      ...
      <div className="grid lg:grid-cols-4 md:grid-cols-2 sm:grid-cols-1 sm:gap-4">
        <div className="flex flex-col lg:items-center justify-start my-4">
          <div className="text-left">
            ...
            <p className="text-1xl opacity-80">Be sure to get your money's worth</p>
          </div>
        </div>
        ...
        <div className="flex flex-col lg:items-center justify-start my-4">
          <div className="text-left">
            ...
            <p className="text-1xl opacity-80">100% Money back guarantee</p>
          </div>
        </div>
        <div className="flex flex-col lg:items-center justify-start my-4">
          <div className="text-left">
            ...
            <p className="text-1xl opacity-80">Never experience a "what I ordered vs what I got" scenario</p>
          </div>
        </div>
        <div className="flex flex-col lg:items-center justify-start my-4">
          <div className="text-left">
            ...
            <p className="text-1xl opacity-80">24/7 Available Support</p>
          </div>
        </div>
      </div>
    </section>
